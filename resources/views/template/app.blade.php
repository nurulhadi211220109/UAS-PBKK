    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
            ...
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
              ...
              <div class="dropdown-list-content dropdown-list-icons">
                ...
                <a href="#" class="dropdown-item">
                  ...
                  <div class="dropdown-item-desc">
                    <b>You</b> and <b>Naila</b> are now friends
                    <div class="time">10 Hours Ago</div>
                  </div>
                </a>
                <a href="#" class="dropdown-item">
                  ...
                  <div class="dropdown-item-desc">
                    <b>Mita</b> has moved task <b>Fix bug header</b> to <b>Done</b>
                    <div class="time">12 Hours Ago</div>
                  </div>
                </a>
                <a href="#" class="dropdown-item">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
              ...
              <div class="d-sm-none d-lg-inline-block">Hi, Hadi</div>
            </a>
      ...
      <div class="main-sidebar sidebar-style-2 bg-dark">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="#" class="nav-item text-white" >Service Komputer</a>
          </div>
          ...
          <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
            <a href="https://www.instagram.com/hadi.ipynb" class="btn btn-primary btn-lg btn-block btn-icon-split">
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2024 <div class="bullet"></div> Design By <a href="#">XD</a>
        </div>
